...
public class EjectorSubsystem extends SubsystemBase {
    ...
    public EjectorSubsystem(HardwareMap hardwareMap, String servoName) {
        ejectorServo = hardwareMap.get(Servo.class, servoName);
     ...
     */
    public void stow() {
        ejectorServo.setPosition(EjectorConstants.Positions.STOW_POSITION);
        currentState = EjectorState.STOWED;
        autoReturnEnabled = false;
    }
     ...
     */
    public void eject() {
        ejectorServo.setPosition(EjectorConstants.Positions.EJECT_POSITION);
    ...
    public void setPosition(double position) {
        ejectorServo.setPosition(position);
    }
    ...
    public double getServoPosition() {
        return ejectorServo.getPosition();
    }
}
